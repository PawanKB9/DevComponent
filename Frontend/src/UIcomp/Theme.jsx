...
const THEMES = {
    light: {
        ...
        bar: "hover:shadow-amber-500 shadow-lg hover:bg-gray-300 bg-zinc-50",
    ...
    dark: {
        ...
        bar: " hover:shadow-green-500 hover:bg-zinc-100",
        card1: "bg-gray-900 text-white",
        ...
        page1: "bg-gray-950 text-white",
        page2: "bg-gray-900 text-white",
    ...
    developer: {
        ...
        bar: "glassyEffect hover:shadow-lg hover:shadow-green-500 hover:bg-zinc-100",
        ...
        innerContainer: "bg-gray-900 p-4 rounded-lg text-green-300",
        ...
        page1: "bg-black text-green-300",
        page2: "bg-gray-900 text-green-300",
        outerContainer: "bg-gray-900",
        shadows1: "bg-gray-100 shadow-lg shadow-zinc-100 hover:shadow-green-500",
        shadows2: "bg-gray-100 shadow-lg  hover:shadow-green-500",
        text: "text-green-400",
